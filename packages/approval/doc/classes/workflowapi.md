...
*Defined in [packages/approval/api.ts:2492](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2492)*
...
*Defined in [packages/approval/api.ts:2504](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2504)*
...
*Defined in [packages/approval/api.ts:2517](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2517)*
...
*Defined in [packages/approval/api.ts:2535](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2535)*
...
*Defined in [packages/approval/api.ts:2551](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2551)*
...
*Defined in [packages/approval/api.ts:2564](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2564)*
...
*Defined in [packages/approval/api.ts:2576](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2576)*
...
*Defined in [packages/approval/api.ts:2589](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2589)*
...
*Defined in [packages/approval/api.ts:2602](https://github.com/fhlavac/javascript-clients/blob/master/packages/approval/api.ts#L2602)*
