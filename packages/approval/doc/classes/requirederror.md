[@redhat-cloud-services/approval-client](../README.md) > [RequiredError](../classes/requirederror.md)
...
*Defined in [api.ts:66](https://github.com/karelhala/javascript-clients/blob/master/packages/approval/api.ts#L66)*
...
*Defined in [api.ts:67](https://github.com/karelhala/javascript-clients/blob/master/packages/approval/api.ts#L67)*
