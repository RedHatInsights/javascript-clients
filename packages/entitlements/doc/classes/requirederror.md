...
*Defined in [api.ts:66](https://github.com/karelhala/javascript-clients/blob/master/packages/entitlements/api.ts#L66)*
...
*Defined in [api.ts:67](https://github.com/karelhala/javascript-clients/blob/master/packages/entitlements/api.ts#L67)*
