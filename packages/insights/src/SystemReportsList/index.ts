...
export type SystemReportsListParams = {
  ...
  * @type { SystemReportsListSystemTypeEnum }
  * @memberof SystemReportsListApi
  */
  systemType?: SystemReportsListSystemTypeEnum,
  /**
...
/**
  ...
  * @enum {string}
  */
export const SystemReportsListSystemTypeEnum = {
    All: 'all',
    Bootc: 'bootc',
    Conventional: 'conventional',
    Edge: 'edge'
} as const;
export type SystemReportsListSystemTypeEnum = typeof SystemReportsListSystemTypeEnum[keyof typeof SystemReportsListSystemTypeEnum];
/**
  * @export
  * @enum {string}
  */
...
*/
export const systemReportsListParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([SystemReportsListParams] | [string, boolean, boolean, Array<string>, boolean, Array<string>, SystemReportsListSystemTypeEnum, Array<string>, Array<SystemReportsListUpdateMethodEnum>, AxiosRequestConfig])) => {
    const params = isSystemReportsListObjectParams(config) ? config[0] : ['uuid', 'filterSystemProfileAnsible', 'filterSystemProfileMssql', 'filterSystemProfileSapSidsContains', 'filterSystemProfileSapSystem', 'groups', 'systemType', 'tags', 'updateMethod', 'options'].reduce((acc, curr, index) => ({ ...acc, [curr]: config[index] }), {}) as SystemReportsListParams;
    const { uuid, filterSystemProfileAnsible, filterSystemProfileMssql, filterSystemProfileSapSidsContains, filterSystemProfileSapSystem, groups, systemType, tags, updateMethod, options = {} } = params;
