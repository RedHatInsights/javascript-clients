...
*/
export const ruleSystemsRetrieveParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([RuleSystemsRetrieveParams] | [string, boolean, boolean, Array<string>, boolean, RuleSystemsRetrieveFormatEnum, Array<string>, string, Array<RuleSystemsRetrieveRhelVersionEnum>, Array<RuleSystemsRetrieveSortEnum>, RuleSystemsRetrieveSystemTypeEnum, Array<string>, Array<RuleSystemsRetrieveUpdateMethodEnum>, AxiosRequestConfig])) => {
