...
export type SystemListParams = {
  ...
  * @type { SystemListSystemTypeEnum }
  * @memberof SystemListApi
  */
  systemType?: SystemListSystemTypeEnum,
  /**
...
/**
  ...
  * @enum {string}
  */
export const SystemListSystemTypeEnum = {
    All: 'all',
    Bootc: 'bootc',
    Conventional: 'conventional',
    Edge: 'edge'
} as const;
export type SystemListSystemTypeEnum = typeof SystemListSystemTypeEnum[keyof typeof SystemListSystemTypeEnum];
/**
  * @export
  * @enum {string}
  */
