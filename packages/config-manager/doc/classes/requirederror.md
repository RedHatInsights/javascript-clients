...
*Defined in [packages/config-manager/base.ts:66](https://github.com/fhlavac/javascript-clients/blob/master/packages/config-manager/base.ts#L66)*
...
*Defined in [packages/config-manager/base.ts:67](https://github.com/fhlavac/javascript-clients/blob/master/packages/config-manager/base.ts#L67)*
