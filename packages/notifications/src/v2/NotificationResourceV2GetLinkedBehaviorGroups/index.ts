...
export type NotificationResourceV2GetLinkedBehaviorGroupsReturnType = PageBehaviorGroup;
...
*/
export const notificationResourceV2GetLinkedBehaviorGroupsParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([NotificationResourceV2GetLinkedBehaviorGroupsParams] | [any, any, any, any, any, any, AxiosRequestConfig])) => {
    ...
    return sendRequest<NotificationResourceV2GetLinkedBehaviorGroupsReturnType>(Promise.resolve(args));
}
