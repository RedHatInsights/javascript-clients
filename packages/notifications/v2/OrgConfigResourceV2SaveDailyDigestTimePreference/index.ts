...
*/
export const orgConfigResourceV2SaveDailyDigestTimePreferenceParamCreator = async (...config: ([OrgConfigResourceV2SaveDailyDigestTimePreferenceParams] | [any, AxiosRequestConfig])): Promise<RequestArgs> => {
