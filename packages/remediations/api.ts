...
export interface NoExecutors {
    /**
     * 
     * @type {Array<NoExecutorsErrors>}
     * @memberof NoExecutor
     */
    errors: Array<NoExecutorsErrors>;
}
/**
 * 
 * @export
 * @interface NoExecutorsError
 */
export interface NoExecutorsErrors {
    /**
     * 
     * @type {string}
     * @memberof NoExecutorsError
     */
    id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface PlaybookDefinitionIssue
 */
export interface PlaybookDefinitionIssues {
    /**
     * 
     * @type {string}
     * @memberof PlaybookDefinitionIssue
     */
    id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface PlaybookExecutorDetail
 */
export interface PlaybookExecutorDetails {
    /**
     * 
     * @type {string}
     * @memberof PlaybookExecutorDetail
     */
    executor_id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface PlaybookExecutorStatu
 */
export interface PlaybookExecutorStatus {
    /**
     * 
     * @type {string}
     * @memberof PlaybookExecutorStatu
     */
 ...
 * 
 * @export
 * @interface PlaybookRunExecutorDetail
 */
export interface PlaybookRunExecutorDetails {
    /**
     * 
     * @type {string}
     * @memberof PlaybookRunExecutorDetail
     */
    id?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface PlaybookRunSystemDetail
 */
export interface PlaybookRunSystemDetails {
    /**
     * 
     * @type {string}
     * @memberof PlaybookRunSystemDetail
     */
    system_id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface PlaybookRunSystem
 */
export interface PlaybookRunSystems {
    /**
     * 
     * @type {string}
     * @memberof PlaybookRunSystem
     */
    system_id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface RemediationConnectionStatu
 */
export interface RemediationConnectionStatus {
    /**
     * 
     * @type {Meta}
     * @memberof RemediationConnectionStatu
     */
    meta: Meta;
    /**
     * 
 ...
 * 
 * @export
 * @interface RemediationInputAddIssue
 */
export interface RemediationInputAddIssues {
    /**
     * 
     * @type {string}
     * @memberof RemediationInputAddIssue
     */
    id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface RemediationListLink
 */
export interface RemediationListLinks {
    /**
     * relative link to the first page of the query result
     * @type {string}
     * @memberof RemediationListLink
     */
    first: string;
    /**
     * relative link to the last page of the query result
     * @type {string}
     * @memberof RemediationListLink
     */
    last: string;
 ...
 * 
 * @export
 * @interface RequestErrorError
 */
export interface RequestErrorErrors {
    /**
     * 
     * @type {string}
     * @memberof RequestErrorError
     */
    id: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface ResolutionsResolution
 */
export interface ResolutionsResolutions {
    /**
     * 
     * @type {string}
     * @memberof ResolutionsResolution
     */
    id: string;
    /**
     * 
...
export const DiagnosisApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary host-specific diagnosi
...
export const GeneratorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Generates an Ansible Playbook based on input parameter
...
export const RemediationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Array<string>} requestBody Array of system inventory identifiers.
         * @param {string} [satOrg] Organization ID passed by satellite
         * @param {boolean} [localhost] Flag for localhost playbook generation
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bulkGetRemediationPlaybook: async (id: string, requestBody: Array<string>, satOrg?: string, localhost?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling bulkGetRemediationPlaybook.');
            }
            // verify required parameter 'requestBody' is not null or undefined
            if (requestBody === null || requestBody === undefined) {
                throw new RequiredError('requestBody','Required parameter requestBody was null or undefined when calling bulkGetRemediationPlaybook.');
            }
        ...
        /**
         * Checks remediation for the existence of smart_managment flaged system
         * @summary Check smart_managment system
         * @param {string} id Remediation identifier
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @summary Bulk Delete Remediation
         ...
         * @summary Get Remediation Issue System
         * @param {string} id Remediation identifier
         * @param {string} issue Issue identifier (e.g. &#x60;advisor:CVE_2017_6074_kernel|KERNEL_CVE_2017_6074&#x60;)
         * @param {number} [limit] Maximum number of results to return
         * @param {number} [offset] Indicates the starting position of the query relative to the complete set of items that match the query
         ...
         * @param {boolean} [hideArchived] Hide archived playbook
         * @param {Array<'name' | 'playbook_runs'>} [fieldsData] Include specified items - name: list all remediation plan names in organization (cannot be combined with other fields) - playbook_runs: include playbook run data in the response 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getRemediations: async (sort?: 'updated_at' | '-updated_at' | 'name' | '-name' | 'system_count' | '-system_count' | 'issue_count' | '-issue_count', filter?: string, limit?: number, offset?: number, system?: string, hideArchived?: boolean, fieldsData?: Array<'name' | 'playbook_runs'>, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/remediations`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
...
export const RemediationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async bulkGetRemediationPlaybook(id: string, requestBody: Array<string>, satOrg?: string, localhost?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await RemediationsApiAxiosParamCreator(configuration).bulkGetRemediationPlaybook(id, requestBody, satOrg, localhost, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RemediationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkGetRemediationPlaybook(id: string, requestBody: Array<string>, satOrg?: string, localhost?: boolean, options?: any): AxiosPromise<string> {
            return RemediationsApiFp(configuration).bulkGetRemediationPlaybook(id, requestBody, satOrg, localhost, options).then((request) => request(axios, basePath));
        },
        /**
         * Cancel execution of the remediation
         * @summary Cancel execution of the remediation
...
export class RemediationsApi extends BaseAPI {
     ...
     */
    public bulkGetRemediationPlaybook(id: string, requestBody: Array<string>, satOrg?: string, localhost?: boolean, options?: any) {
        return RemediationsApiFp(this.configuration).bulkGetRemediationPlaybook(id, requestBody, satOrg, localhost, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RemediationsApi
     */
    public getRemediations(sort?: 'updated_at' | '-updated_at' | 'name' | '-name' | 'system_count' | '-system_count' | 'issue_count' | '-issue_count', filter?: string, limit?: number, offset?: number, system?: string, hideArchived?: boolean, fieldsData?: Array<'name' | 'playbook_runs'>, options?: any) {
