...
export interface HostOut {
    ...
    /**
     * The ansible host name for remediation
     * @type {string}
     * @memberof HostOut
     */
...
/**
 * A collection of pagination links for resource-types endpoint
 * @export
 * @interface Link
 */
...
/**
 * The metadata for resource-types response
 * @export
 * @interface Meta
 */
 ...
 * 
 * @export
 * @interface PerReporterStalene
 */
export interface PerReporterStaleness {
    /**
     * 
     * @type {string}
     * @memberof PerReporterStalene
     */
...
/**
 * Representation of the system profile field
 * @export
...
export interface SystemProfile {
    ...
    /**
     * The version number of insights client. supports wildcard
     * @type {string}
     * @memberof SystemProfile
     */
...
/**
 * Object containing image data from command bootc statu
 * @export
 * @interface SystemProfileBootcStatu
 */
export interface SystemProfileBootcStatus {
    /**
     * 
     * @type {SystemProfileBootcStatusBooted}
     * @memberof SystemProfileBootcStatu
     */
...
/**
 * Object containing information about 3rd party migration on instance
 * @export
 * @interface SystemProfileConversion
 */
export interface SystemProfileConversions {
    /**
     * Whether the conversion activity has been done or not
     * @type {boolean}
     * @memberof SystemProfileConversion
     */
    activity?: boolean;
}
/**
...
/**
 * Object for OS details. Supports range operation
 * @export
...
/**
 * Object for subscription-manager detail
 * @export
 ...
 * 
 * @export
 * @interface SystemProfileSapSystemOutResult
 */
export interface SystemProfileSapSystemOutResults {
    /**
     * 
     * @type {string | boolean}
     * @memberof SystemProfileSapSystemOutResult
     */
...
export interface TagCountOut {
    ...
    total: number;
    /**
     * The list of tags on the system
...
export const AccountsStalenessApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Delete an account stalene
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @summary Read the entire list of account stalene
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const GroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Find assignment rules by their ID
         ...
         * @param {'ASC' | 'DESC'} [orderHow] Direction of the ordering; defaults to ASC for name, and to DESC for host_id
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @summary Create a new group matching the provided name and list of hosts ID
         ...
         * @summary Delete a list of group
         ...
         * @summary Read the entire list of group
         ...
         * @summary Find groups by their ID
         * @param {Array<string>} groupIdList A comma-separated list of group IDs.
         * @param {number} [perPage] A number of items to return per page.
         * @param {number} [page] A page number of the items to return.
         * @param {'name' | 'host_count' | 'updated'} [orderBy] Ordering field name
...
export const HostsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Delete the entire list of hosts filtered by the given parameter
         ...
         * @param {Array<'insights' | 'yupana' | 'satellite' | 'discovery' | 'puptoo' | 'rhsm-conduit' | 'cloud-connector' | '!yupana' | '!satellite' | '!discovery' | '!puptoo' | '!rhsm-conduit' | '!cloud-connector'>} [registeredWith] Filters out any host not registered by the specified reporter
         * @param {Array<'fresh' | 'stale' | 'stale_warning' | 'unknown'>} [staleness] Culling states of the hosts.
         * @param {Array<string>} [tags] filters out hosts not tagged by the given tag
         ...
         * @summary Find hosts by their ID
         * @param {Array<string>} hostIdList A comma-separated list of host IDs.
         * @param {string} [branchId] Filter by branch_id
         * @param {number} [perPage] A number of items to return per page.
         * @param {number} [page] A page number of the items to return.
         ...
         * @summary Read the entire list of host
         * @param {string} [displayName] Filter by display_name (case-insensitive)
         * @param {string} [fqdn] Filter by FQDN (case-insensitive)
         * @param {string} [hostnameOrId] Filter by display_name, fqdn, id (case-insensitive)
         * @param {string} [insightsId] Filter by insights_id
         ...
         * @summary Get the number of tags on a host or host
         * @param {Array<string>} hostIdList A comma-separated list of host IDs.
         * @param {number} [perPage] A number of items to return per page.
         * @param {number} [page] A page number of the items to return.
         * @param {'display_name' | 'group_name' | 'updated' | 'operating_system'} [orderBy] Ordering field name
         ...
         * @summary Update staleness timestamps for a host matching the provided fact
...
export const ResourceTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Get the list of resource type
         * @param {number} [perPage] A number of items to return per page.
         * @param {number} [page] A page number of the items to return.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
