...
// @ts-ignore
import type { ContainerGroupsCollection, ListClustersSortByParameter } from '../types';


export type ListContainerGroupsParams = {
  /**
...
* @param {ListContainerGroupsParams} config with all available params.
