...
// @ts-ignore
import type { ListClustersSortByParameter, ServiceOfferingsCollection } from '../types';


export type ListServiceOfferingsParams = {
  /**
...
* @param {ListServiceOfferingsParams} config with all available params.
