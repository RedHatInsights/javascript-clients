...
*Defined in [packages/topological-inventory/base.ts:20](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L20)*
...
*Defined in [packages/topological-inventory/api.ts:4139](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/api.ts#L4139)*
...
*Defined in [packages/topological-inventory/api.ts:17162](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/api.ts#L17162)*
...
*Defined in [packages/topological-inventory/api.ts:14157](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/api.ts#L14157)*
...
*Defined in [packages/topological-inventory/base.ts:26](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L26)*
...
*Defined in [packages/topological-inventory/base.ts:27](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L27)*

###  pipes

• **pipes**: *string* = "|"

*Defined in [packages/topological-inventory/base.ts:30](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L30)*

###  ssv

• **ssv**: *string* = " "

*Defined in [packages/topological-inventory/base.ts:28](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L28)*

###  tsv

• **tsv**: *string* = "	"

*Defined in [packages/topological-inventory/base.ts:29](https://github.com/fhlavac/javascript-clients/blob/master/packages/topological-inventory/base.ts#L29)*
