...
// @ts-ignore
import type { ErrorNotFound, ListClustersSortByParameter, VolumeAttachmentsCollection } from '../types';


export type ListVmVolumeAttachmentsParams = {
  /**
  * ID of the resource
  * @type { string }
...
* @param {ListVmVolumeAttachmentsParams} config with all available params.
