...
// @ts-ignore
import type { ListClustersSortByParameter, SubnetsCollection } from '../types';


export type ListSubnetsParams = {
  /**
...
* @param {ListSubnetsParams} config with all available params.
