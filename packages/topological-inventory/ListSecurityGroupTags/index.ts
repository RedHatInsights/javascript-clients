...
export type ListSecurityGroupTagsReturnType = TagsCollection;
...
*/
export const listSecurityGroupTagsParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([ListSecurityGroupTagsParams] | [string, number, number, object, ListClustersSortByParameter, AxiosRequestConfig])) => {
    ...
    return sendRequest<ListSecurityGroupTagsReturnType>(Promise.resolve(args));
}
