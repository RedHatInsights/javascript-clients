...
export type ListClusterHostsReturnType = HostsCollection;
...
*/
export const listClusterHostsParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([ListClusterHostsParams] | [string, number, number, object, ListClustersSortByParameter, AxiosRequestConfig])) => {
    ...
    return sendRequest<ListClusterHostsReturnType>(Promise.resolve(args));
}
