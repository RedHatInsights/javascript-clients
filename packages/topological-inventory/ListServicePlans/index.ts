...
// @ts-ignore
import type { ListClustersSortByParameter, ServicePlansCollection } from '../types';


export type ListServicePlansParams = {
  /**
...
* @param {ListServicePlansParams} config with all available params.
