...
export type EndpointResourceV2GetEndpointReturnType = Endpoint;
...
*/
export const endpointResourceV2GetEndpointParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([EndpointResourceV2GetEndpointParams] | [any, AxiosRequestConfig])) => {
    ...
    return sendRequest<EndpointResourceV2GetEndpointReturnType>(Promise.resolve(args));
}
