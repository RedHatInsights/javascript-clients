...
*Defined in [packages/sources/base.ts:20](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L20)*
...
*Defined in [packages/sources/api.ts:786](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/api.ts#L786)*
...
*Defined in [packages/sources/api.ts:3026](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/api.ts#L3026)*
...
*Defined in [packages/sources/api.ts:2492](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/api.ts#L2492)*
...
*Defined in [packages/sources/base.ts:26](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L26)*
...
*Defined in [packages/sources/base.ts:27](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L27)*

###  pipes

• **pipes**: *string* = "|"

*Defined in [packages/sources/base.ts:30](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L30)*

###  ssv

• **ssv**: *string* = " "

*Defined in [packages/sources/base.ts:28](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L28)*

###  tsv

• **tsv**: *string* = "	"

*Defined in [packages/sources/base.ts:29](https://github.com/fhlavac/javascript-clients/blob/master/packages/sources/base.ts#L29)*
