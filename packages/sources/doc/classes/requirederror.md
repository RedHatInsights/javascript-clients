[@redhat-cloud-services/sources-client](../README.md) > [RequiredError](../classes/requirederror.md)
...
*Defined in [api.ts:66](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/sources/api.ts#L66)*
...
*Defined in [api.ts:67](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/sources/api.ts#L67)*
