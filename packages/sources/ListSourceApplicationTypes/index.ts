...
export type ListSourceApplicationTypesReturnType = ApplicationTypesCollection;
...
*/
export const listSourceApplicationTypesParamCreator = async (sendRequest: BaseAPI["sendRequest"], ...config: ([ListSourceApplicationTypesParams] | [string, number, number, object, ListApplicationTypesSortByParameter, AxiosRequestConfig])) => {
    ...
    return sendRequest<ListSourceApplicationTypesReturnType>(Promise.resolve(args));
}
