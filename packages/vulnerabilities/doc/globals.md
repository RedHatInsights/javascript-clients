...
*Defined in [api.ts:2637](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L2637)*
...
* **getCveDetails**(`cveId`: string, `options`: any): *Promise‹[RequestArgs](interfaces/requestargs.md)›*
...
*Defined in [api.ts:5630](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L5630)*
...
*Defined in [api.ts:5032](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L5032)*
...
* **getCveDetails**(`cveId`: string, `options?`: any): *Promise‹function›*
