...
*Defined in [packages/vulnerabilities/api.ts:4768](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L4768)*
...
*Defined in [packages/vulnerabilities/api.ts:4781](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L4781)*
...
*Defined in [packages/vulnerabilities/api.ts:4793](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L4793)*
...
*Defined in [packages/vulnerabilities/api.ts:4805](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L4805)*
