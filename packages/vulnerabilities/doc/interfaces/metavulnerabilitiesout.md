...
*Defined in [packages/vulnerabilities/api.ts:1803](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L1803)*
...
*Defined in [packages/vulnerabilities/api.ts:1809](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L1809)*
...
*Defined in [packages/vulnerabilities/api.ts:1815](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L1815)*
...
*Defined in [packages/vulnerabilities/api.ts:1845](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/api.ts#L1845)*
