...
export interface OSExposureReport {
    /**
     *
     * @type {Array<OSExposureReportData>}
     * @memberof OSExposureReport
     */
    data: Array<OSExposureReportData>;
}
/**
 *
 * @export
 ...
 */
export interface OSExposureReportData {
    /**
     * Name of the operating system.
     * @type {string}
     * @memberof OSExposureReportData
     */
    name: string;
    /**
     ...
     * @memberof OSExposureReportData
     */
    cves_important: number;
    /**
     * Number of CVEs with Moderate severity.
     * @type {number}
     * @memberof OSExposureReportData
     */
    cves_moderate: number;
    /**
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOSExposure: async (options: any = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getOSExposure(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OSExposureReport>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getOSExposure(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOSExposure(options?: any): AxiosPromise<OSExposureReport> {
            return DefaultApiFp(configuration).getOSExposure(options).then((request) => request(axios, basePath));
        },
        /**
         * This returns an Ansible playbook template for a given rule identification number. Use this endpoint to return an Ansible playbook template for a given rule error key. The template is used to remediate issues on your system.
         * @summary Get an Ansible Playbook template for CVEs with security rules
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getOSExposure(options?: any) {
        return DefaultApiFp(this.configuration).getOSExposure(options).then((request) => request(this.axios, this.basePath));
    }
