...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDashbar: async (options: any = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getDashbar(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DashbarOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getDashbar(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDashbar(options?: any): AxiosPromise<DashbarOut> {
            return DefaultApiFp(configuration).getDashbar(options).then((request) => request(axios, basePath));
        },
        /**
         * Returns top level overview of vulnerabilities affecting given account.
         * @summary Top level overview of vulnerabilities.
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getDashbar(options?: any) {
        return DefaultApiFp(this.configuration).getDashbar(options).then((request) => request(this.axios, this.basePath));
    }
