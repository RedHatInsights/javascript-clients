 ...
 *
 * @export
 * @interface SystemCvePackagesOut
 */
export interface SystemCvePackagesOut {
    /**
     * Packages affected by the CVE on the system.
     * @type {Array<SystemCvePackagesOutData>}
     * @memberof SystemCvePackagesOut
     */
    data: Array<SystemCvePackagesOutData>;
    /**
     *
     * @type {MetaPermissions}
     * @memberof SystemCvePackagesOut
 ...
 *
 * @export
 * @interface SystemCvePackagesOutData
 */
export interface SystemCvePackagesOutData {
    /**
     * Package name.
     * @type {string}
     * @memberof SystemCvePackagesOutData
     */
    package_name: string;
    /**
     * Installed affected epoch, version, release, and architecture.
     * @type {string}
     * @memberof SystemCvePackagesOutData
     */
    affected_evra: string;
    /**
     * Fixed epoch, version, release, and architecture, when available.
     * @type {string}
     * @memberof SystemCvePackagesOutData
     */
    fixed_evra: string | null;
}
/**
 *
 * @export
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAffectedPackagesBySystemCve: async (inventoryId: string, cveId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'inventoryId' is not null or undefined
            if (inventoryId === null || inventoryId === undefined) {
                throw new RequiredError('inventoryId','Required parameter inventoryId was null or undefined when calling getAffectedPackagesBySystemCve.');
            }
            // verify required parameter 'cveId' is not null or undefined
            if (cveId === null || cveId === undefined) {
                throw new RequiredError('cveId','Required parameter cveId was null or undefined when calling getAffectedPackagesBySystemCve.');
            }
            const localVarPath = `/systems/{inventory_id}/cves/{cve_id}/packages`
         ...
         * @param {boolean} [sapSystem] Boolean value which shows systems running SAP workload.
         ...
         * @param {boolean} [ansible] Boolean value which shows systems running Ansible Automation Platform workload.
         * @param {boolean} [mssql] Boolean value which shows systems running MSSQL workload.
         * @param {boolean} [crowdstrike] Boolean value which shows systems running CrowdStrike workload.
         * @param {boolean} [ibmDb2] Boolean value which shows systems running IBM DB2 workload.
         * @param {boolean} [intersystems] Boolean value which shows systems running InterSystems workload.
         * @param {boolean} [oracleDb] Boolean value which shows systems running Oracle DB workload.
         * @param {boolean} [rhelAi] Boolean value which shows systems running RHEL AI workload.
         * @param {boolean} [satellite] Boolean value which shows systems running Satellite (server or capsule) workload.
        ...
        getAffectedSystemsByCve: async (cveId: string, filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, statusId?: string, dataFormat?: string, uuid?: string, ruleKey?: Array<string>, rulePresence?: Array<boolean>, rule?: Array<string>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, showAdvisories?: boolean, advisory?: string, rhelVersion?: string, firstReportedFrom?: string, firstReportedTo?: string, advisoryAvailable?: Array<boolean>, remediation?: string, report?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options: any = {}): Promise<RequestArgs> => {
            ...
            if (crowdstrike !== undefined) {
                localVarQueryParameter['crowdstrike'] = crowdstrike;
            }

            if (ibmDb2 !== undefined) {
                localVarQueryParameter['ibm_db2'] = ibmDb2;
            }

            if (intersystems !== undefined) {
                localVarQueryParameter['intersystems'] = intersystems;
            }

            if (oracleDb !== undefined) {
                localVarQueryParameter['oracle_db'] = oracleDb;
            }

            if (rhelAi !== undefined) {
                localVarQueryParameter['rhel_ai'] = rhelAi;
            }
         ...
         * @throws {RequiredError}
         */
        getCveIdsList: async (filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getCveList: async (filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, report?: boolean, advancedReport?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, groupNames?: Array<string>, groupIds?: Array<string>, affectingHostType?: Array<'rpmdnf' | 'image' | 'edge' | 'none'>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getDashbar: async (tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getDashboard: async (tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSystemsIds: async (filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getSystemsList: async (filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, report?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options: any = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAffectedPackagesBySystemCve(inventoryId: string, cveId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemCvePackagesOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getAffectedPackagesBySystemCve(inventoryId, cveId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getCveIdsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VulnerabilitiesIdsOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getCveIdsList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getCveList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, report?: boolean, advancedReport?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, groupNames?: Array<string>, groupIds?: Array<string>, affectingHostType?: Array<'rpmdnf' | 'image' | 'edge' | 'none'>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VulnerabilitiesOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getCveList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, report, advancedReport, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, groupNames, groupIds, affectingHostType, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getDashbar(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DashbarOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getDashbar(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getDashboard(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dashboard>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getDashboard(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getSystemsIds(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemIdsOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getSystemsIds(filter, limit, offset, page, pageSize, sort, dataFormat, stale, uuid, tags, sapSids, sapSystem, excluded, rhelVersion, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, groupNames, groupIds, hostType, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getSystemsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, report?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemListOut>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).getSystemsList(filter, limit, offset, page, pageSize, sort, dataFormat, stale, uuid, tags, sapSids, sapSystem, excluded, rhelVersion, report, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, groupNames, groupIds, hostType, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAffectedPackagesBySystemCve(inventoryId: string, cveId: string, options?: any): AxiosPromise<SystemCvePackagesOut> {
            return DefaultApiFp(configuration).getAffectedPackagesBySystemCve(inventoryId, cveId, options).then((request) => request(axios, basePath));
        },
        /**
         * This is a report of affected systems for a given CVE. Use this request to obtain server identification numbers of all affected servers along with last check-in, system name and more.
         * @summary Determine affected systems for a given CVE
         ...
         * @throws {RequiredError}
         */
        getCveIdsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, options?: any): AxiosPromise<VulnerabilitiesIdsOut> {
            return DefaultApiFp(configuration).getCveIdsList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, options).then((request) => request(axios, basePath));
        },
        /**
         * This provides an overview of vulnerabilities across your entire system inventory. Use this endpoint to get an overview of which CVEs are affecting your account, including some CVE metadata, how many systems are affected by each CVE, and more.
         * @summary Get a vulnerabilities overview
        ...
        getCveList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, report?: boolean, advancedReport?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, groupNames?: Array<string>, groupIds?: Array<string>, affectingHostType?: Array<'rpmdnf' | 'image' | 'edge' | 'none'>, options?: any): AxiosPromise<VulnerabilitiesOut> {
            return DefaultApiFp(configuration).getCveList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, report, advancedReport, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, groupNames, groupIds, affectingHostType, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint displays detailed information about all CVEs for which a system is exposed. Use this endpoint to discover which CVEs are affecting a given system. CVE metadata is included.
         * @summary Get a CVE report for a system
         ...
         * @throws {RequiredError}
         */
        getDashbar(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any): AxiosPromise<DashbarOut> {
            return DefaultApiFp(configuration).getDashbar(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options).then((request) => request(axios, basePath));
        },
        /**
         * These are aggregations summarizing your account such as number of unique CVEs, list of security rules, CVEs by severity, and more. Use this endpoint to obtain a snapshot of all the CVES and details about their prevalence and severity.
         * @summary Get a macro level overview of aggregated vulnerabilities
         ...
         * @throws {RequiredError}
         */
        getDashboard(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any): AxiosPromise<Dashboard> {
            return DefaultApiFp(configuration).getDashboard(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options).then((request) => request(axios, basePath));
        },
        /**
         * This returns an overview of vulnerabilities affecting a given account. Use this request when you need to download a high-level, executive report summarizing the security exposure of your infrastructure. These reports are designed for an executive audience and include data such as the number of RHEL systems analyzed, the number of security rules in your infrastructure, percentage of CVEs with a certain severity and more.
         * @summary Generate an executive report
        ...
        getSystemsIds(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options?: any): AxiosPromise<SystemIdsOut> {
            return DefaultApiFp(configuration).getSystemsIds(filter, limit, offset, page, pageSize, sort, dataFormat, stale, uuid, tags, sapSids, sapSystem, excluded, rhelVersion, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, groupNames, groupIds, hostType, options).then((request) => request(axios, basePath));
        },
        /**
         * List systems that are accessible when you are logged into your account. Use this endpoint to view basic system attributes such as display name and system type.
         * @summary List systems
        ...
        getSystemsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, report?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options?: any): AxiosPromise<SystemListOut> {
            return DefaultApiFp(configuration).getSystemsList(filter, limit, offset, page, pageSize, sort, dataFormat, stale, uuid, tags, sapSids, sapSystem, excluded, rhelVersion, report, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, groupNames, groupIds, hostType, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint will provide you with the application version. Use this endpoint to track application changes.
         * @summary Get application version
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public getAffectedPackagesBySystemCve(inventoryId: string, cveId: string, options?: any) {
        return DefaultApiFp(this.configuration).getAffectedPackagesBySystemCve(inventoryId, cveId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getCveIdsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, options?: any) {
        return DefaultApiFp(this.configuration).getCveIdsList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getCveList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, cvssFrom?: number, cvssTo?: number, publicFrom?: string, publicTo?: string, impact?: string, dataFormat?: string, businessRiskId?: string, statusId?: string, rulePresence?: Array<boolean>, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, knownExploit?: Array<boolean>, affecting?: Array<boolean>, rhelVersion?: string, report?: boolean, advancedReport?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, advisoryAvailable?: Array<boolean>, groupNames?: Array<string>, groupIds?: Array<string>, affectingHostType?: Array<'rpmdnf' | 'image' | 'edge' | 'none'>, options?: any) {
        return DefaultApiFp(this.configuration).getCveList(filter, limit, offset, page, pageSize, sort, cvssFrom, cvssTo, publicFrom, publicTo, impact, dataFormat, businessRiskId, statusId, rulePresence, tags, sapSids, sapSystem, knownExploit, affecting, rhelVersion, report, advancedReport, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, advisoryAvailable, groupNames, groupIds, affectingHostType, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getDashbar(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any) {
        return DefaultApiFp(this.configuration).getDashbar(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public getDashboard(tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, options?: any) {
        return DefaultApiFp(this.configuration).getDashboard(tags, sapSids, sapSystem, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getSystemsList(filter?: string, limit?: number, offset?: number, page?: number, pageSize?: number, sort?: string, dataFormat?: string, stale?: boolean, uuid?: string, tags?: Array<string>, sapSids?: Array<string>, sapSystem?: boolean, excluded?: Array<boolean>, rhelVersion?: string, report?: boolean, ansible?: boolean, mssql?: boolean, crowdstrike?: boolean, ibmDb2?: boolean, intersystems?: boolean, oracleDb?: boolean, rhelAi?: boolean, satellite?: boolean, groupNames?: Array<string>, groupIds?: Array<string>, hostType?: Array<'rpmdnf' | 'image' | 'edge'>, options?: any) {
        return DefaultApiFp(this.configuration).getSystemsList(filter, limit, offset, page, pageSize, sort, dataFormat, stale, uuid, tags, sapSids, sapSystem, excluded, rhelVersion, report, ansible, mssql, crowdstrike, ibmDb2, intersystems, oracleDb, rhelAi, satellite, groupNames, groupIds, hostType, options).then((request) => request(this.axios, this.basePath));
    }
