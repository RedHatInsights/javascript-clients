...
*Defined in [git-api/api.ts:66](https://github.com/karelhala/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L66)*
...
*Defined in [git-api/api.ts:67](https://github.com/karelhala/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L67)*
