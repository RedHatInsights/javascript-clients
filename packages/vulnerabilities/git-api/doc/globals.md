...
*Defined in [packages/vulnerabilities/git-api/api.ts:5143](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L5143)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:4595](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L4595)*
