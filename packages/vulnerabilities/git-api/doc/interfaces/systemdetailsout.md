...
*Defined in [packages/vulnerabilities/git-api/api.ts:2056](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L2056)*
