...
*Defined in [packages/vulnerabilities/git-api/api.ts:1352](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L1352)*
