...
*Defined in [packages/vulnerabilities/git-api/api.ts:2003](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L2003)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:2009](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L2009)*
