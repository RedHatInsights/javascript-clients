...
*Defined in [packages/vulnerabilities/git-api/api.ts:360](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L360)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:366](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L366)*
