...
*Defined in [packages/vulnerabilities/git-api/api.ts:147](https://github.com/fhlavac/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L147)*
