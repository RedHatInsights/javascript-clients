...
*Defined in [packages/vulnerabilities/git-api/api.ts:763](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L763)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:769](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L769)*
...
*Defined in [packages/vulnerabilities/git-api/api.ts:775](https://github.com/RedHatInsights/javascript-clients/blob/master/packages/vulnerabilities/git-api/api.ts#L775)*
