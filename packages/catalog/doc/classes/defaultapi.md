...
*Defined in [packages/catalog/api.ts:1577](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1577)*
...
*Defined in [packages/catalog/api.ts:1589](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1589)*
