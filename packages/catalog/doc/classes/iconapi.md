...
*Defined in [packages/catalog/api.ts:1789](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1789)*
...
*Defined in [packages/catalog/api.ts:1801](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1801)*
