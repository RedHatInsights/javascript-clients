...
*Defined in [packages/catalog/api.ts:1218](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1218)*
...
*Defined in [packages/catalog/api.ts:1212](https://github.com/fhlavac/javascript-clients/blob/master/packages/catalog/api.ts#L1212)*
