...
// @ts-ignore
import type { ControllersAdvisoriesDBLookup, UtilsErrorResponse } from '../types';


export type ExportAdvisoriesParams = {
  /**
  * Find matching text
  * @type { string }
...
* @param {ExportAdvisoriesParams} config with all available params.
