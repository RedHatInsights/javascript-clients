 ...
 *
 * The version of the OpenAPI document: v3.7.10
 *
 *
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [filterTemplateName] Filter
         * @param {string} [filterTemplateUuid] Filter
         ...
         * @throws {RequiredError}
         */
        exportTemplateSystems: async (templateId: string, search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'templateId' is not null or undefined
            if (templateId === null || templateId === undefined) {
                throw new RequiredError('templateId','Required parameter templateId was null or undefined when calling exportTemplateSystems.');
            }
         ...
         * @param {number} [limit] Limit for paging
         * @param {number} [offset] Offset for paging
         * @param {'id' | 'name' | 'systems' | 'published' | 'last_edited'} [sort] Sort field
         * @param {string} [search] Find matching text
         * @param {string} [filterId] Filter
         * @param {string} [filterName] Filter
         * @param {string} [filterSystems] Filter
         ...
         * @throws {RequiredError}
         */
        listTemplate: async (limit?: number, offset?: number, sort?: 'id' | 'name' | 'systems' | 'published' | 'last_edited', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listTemplateSystems: async (templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload' | 'groups', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'templateId' is not null or undefined
            if (templateId === null || templateId === undefined) {
                throw new RequiredError('templateId','Required parameter templateId was null or undefined when calling listTemplateSystems.');
            }
         ...
         * @throws {RequiredError}
         */
        listTemplateSystemsIds: async (templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'templateId' is not null or undefined
            if (templateId === null || templateId === undefined) {
                throw new RequiredError('templateId','Required parameter templateId was null or undefined when calling listTemplateSystemsIds.');
            }
         ...
         * @param {ControllersTemplateSystemsUpdateRequest} body Request body
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        removeTemplateSystems: async (body: ControllersTemplateSystemsUpdateRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling removeTemplateSystems.');
            }
         ...
         * @throws {RequiredError}
         */
        updateTemplateSystems: async (templateId: string, body: ControllersTemplateSystemsUpdateRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'templateId' is not null or undefined
            if (templateId === null || templateId === undefined) {
                throw new RequiredError('templateId','Required parameter templateId was null or undefined when calling updateTemplateSystems.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling updateTemplateSystems.');
            }
            const localVarPath = `/templates/{template_id}/systems`
                .replace(`{${"template_id"}}`, encodeURIComponent(String(templateId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async exportTemplateSystems(templateId: string, search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ControllersTemplateSystemsDBLookup>>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).exportTemplateSystems(templateId, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async listSystemsIds(limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'last_upload' | 'rhsa_count' | 'rhba_count' | 'rhea_count' | 'other_count' | 'stale' | 'packages_installed' | 'baseline_name' | 'satellite_managed' | 'built_pkgcache', search?: string, filterId?: string, filterDisplayName?: string, filterLastEvaluation?: string, filterLastUpload?: string, filterRhsaCount?: string, filterRhbaCount?: string, filterRheaCount?: string, filterOtherCount?: string, filterInstallableRhsaCount?: string, filterInstallableRhbaCount?: string, filterInstallableRheaCount?: string, filterInstallableOtherCount?: string, filterApplicableRhsaCount?: string, filterApplicableRhbaCount?: string, filterApplicableRheaCount?: string, filterApplicableOtherCount?: string, filterStale?: string, filterPackagesInstalled?: string, filterPackagesInstallable?: string, filterPackagesApplicable?: string, filterStaleTimestamp?: string, filterStaleWarningTimestamp?: string, filterCulledTimestamp?: string, filterCreated?: string, filterBaselineName?: string, filterTemplateName?: string, filterTemplateUuid?: string, filterOs?: string, filterOsname?: string, filterOsmajor?: string, filterOsminor?: string, filterSatelliteManaged?: string, filterBuiltPkgcache?: string, filterArch?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersIDsSatelliteManagedResponse>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listSystemsIds(limit, offset, sort, search, filterId, filterDisplayName, filterLastEvaluation, filterLastUpload, filterRhsaCount, filterRhbaCount, filterRheaCount, filterOtherCount, filterInstallableRhsaCount, filterInstallableRhbaCount, filterInstallableRheaCount, filterInstallableOtherCount, filterApplicableRhsaCount, filterApplicableRhbaCount, filterApplicableRheaCount, filterApplicableOtherCount, filterStale, filterPackagesInstalled, filterPackagesInstallable, filterPackagesApplicable, filterStaleTimestamp, filterStaleWarningTimestamp, filterCulledTimestamp, filterCreated, filterBaselineName, filterTemplateName, filterTemplateUuid, filterOs, filterOsname, filterOsmajor, filterOsminor, filterSatelliteManaged, filterBuiltPkgcache, filterArch, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listTemplate(limit?: number, offset?: number, sort?: 'id' | 'name' | 'systems' | 'published' | 'last_edited', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersTemplatesResponse>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listTemplate(limit, offset, sort, search, filterId, filterName, filterSystems, tags, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listTemplateSystems(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload' | 'groups', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersTemplateSystemsResponse>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listTemplateSystems(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listTemplateSystemsIds(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersIDsPlainResponse>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listTemplateSystemsIds(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async removeTemplateSystems(body: ControllersTemplateSystemsUpdateRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).removeTemplateSystems(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateTemplateSystems(templateId: string, body: ControllersTemplateSystemsUpdateRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).updateTemplateSystems(templateId, body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        exportTemplateSystems(templateId: string, search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): AxiosPromise<Array<ControllersTemplateSystemsDBLookup>> {
            return DefaultApiFp(configuration).exportTemplateSystems(templateId, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me metadata of selected package
         * @summary Show me metadata of selected package
        ...
        listSystems(limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'last_upload' | 'rhsa_count' | 'rhba_count' | 'rhea_count' | 'other_count' | 'stale' | 'packages_installed' | 'baseline_name' | 'groups' | 'satellite_managed' | 'built_pkgcache', search?: string, filterId?: string, filterDisplayName?: string, filterLastEvaluation?: string, filterLastUpload?: string, filterRhsaCount?: string, filterRhbaCount?: string, filterRheaCount?: string, filterOtherCount?: string, filterInstallableRhsaCount?: string, filterInstallableRhbaCount?: string, filterInstallableRheaCount?: string, filterInstallableOtherCount?: string, filterApplicableRhsaCount?: string, filterApplicableRhbaCount?: string, filterApplicableRheaCount?: string, filterApplicableOtherCount?: string, filterStale?: string, filterPackagesInstalled?: string, filterPackagesInstallable?: string, filterPackagesApplicable?: string, filterStaleTimestamp?: string, filterStaleWarningTimestamp?: string, filterCulledTimestamp?: string, filterCreated?: string, filterBaselineName?: string, filterTemplateName?: string, filterTemplateUuid?: string, filterSatelliteManaged?: string, filterBuiltPkgcache?: string, filterArch?: string, filterOs?: string, filterOsname?: string, filterOsmajor?: string, filterOsminor?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): AxiosPromise<ControllersSystemsResponse> {
            return DefaultApiFp(configuration).listSystems(limit, offset, sort, search, filterId, filterDisplayName, filterLastEvaluation, filterLastUpload, filterRhsaCount, filterRhbaCount, filterRheaCount, filterOtherCount, filterInstallableRhsaCount, filterInstallableRhbaCount, filterInstallableRheaCount, filterInstallableOtherCount, filterApplicableRhsaCount, filterApplicableRhbaCount, filterApplicableRheaCount, filterApplicableOtherCount, filterStale, filterPackagesInstalled, filterPackagesInstallable, filterPackagesApplicable, filterStaleTimestamp, filterStaleWarningTimestamp, filterCulledTimestamp, filterCreated, filterBaselineName, filterTemplateName, filterTemplateUuid, filterSatelliteManaged, filterBuiltPkgcache, filterArch, filterOs, filterOsname, filterOsmajor, filterOsminor, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me all my systems
         * @summary Show me all my systems
        ...
        listSystemsIds(limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'last_upload' | 'rhsa_count' | 'rhba_count' | 'rhea_count' | 'other_count' | 'stale' | 'packages_installed' | 'baseline_name' | 'satellite_managed' | 'built_pkgcache', search?: string, filterId?: string, filterDisplayName?: string, filterLastEvaluation?: string, filterLastUpload?: string, filterRhsaCount?: string, filterRhbaCount?: string, filterRheaCount?: string, filterOtherCount?: string, filterInstallableRhsaCount?: string, filterInstallableRhbaCount?: string, filterInstallableRheaCount?: string, filterInstallableOtherCount?: string, filterApplicableRhsaCount?: string, filterApplicableRhbaCount?: string, filterApplicableRheaCount?: string, filterApplicableOtherCount?: string, filterStale?: string, filterPackagesInstalled?: string, filterPackagesInstallable?: string, filterPackagesApplicable?: string, filterStaleTimestamp?: string, filterStaleWarningTimestamp?: string, filterCulledTimestamp?: string, filterCreated?: string, filterBaselineName?: string, filterTemplateName?: string, filterTemplateUuid?: string, filterOs?: string, filterOsname?: string, filterOsmajor?: string, filterOsminor?: string, filterSatelliteManaged?: string, filterBuiltPkgcache?: string, filterArch?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): AxiosPromise<ControllersIDsSatelliteManagedResponse> {
            return DefaultApiFp(configuration).listSystemsIds(limit, offset, sort, search, filterId, filterDisplayName, filterLastEvaluation, filterLastUpload, filterRhsaCount, filterRhbaCount, filterRheaCount, filterOtherCount, filterInstallableRhsaCount, filterInstallableRhbaCount, filterInstallableRheaCount, filterInstallableOtherCount, filterApplicableRhsaCount, filterApplicableRhbaCount, filterApplicableRheaCount, filterApplicableOtherCount, filterStale, filterPackagesInstalled, filterPackagesInstallable, filterPackagesApplicable, filterStaleTimestamp, filterStaleWarningTimestamp, filterCulledTimestamp, filterCreated, filterBaselineName, filterTemplateName, filterTemplateUuid, filterOs, filterOsname, filterOsmajor, filterOsminor, filterSatelliteManaged, filterBuiltPkgcache, filterArch, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Show all templates for an account
         * @summary Show all templates for an account
         ...
         * @throws {RequiredError}
         */
        listTemplate(limit?: number, offset?: number, sort?: 'id' | 'name' | 'systems' | 'published' | 'last_edited', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any): AxiosPromise<ControllersTemplatesResponse> {
            return DefaultApiFp(configuration).listTemplate(limit, offset, sort, search, filterId, filterName, filterSystems, tags, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me all systems applicable to a template
         * @summary Show me all systems belonging to a template
         ...
         * @throws {RequiredError}
         */
        listTemplateSystems(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload' | 'groups', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any): AxiosPromise<ControllersTemplateSystemsResponse> {
            return DefaultApiFp(configuration).listTemplateSystems(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me all systems applicable to a template
         * @summary Show me all systems belonging to a template
         ...
         * @throws {RequiredError}
         */
        listTemplateSystemsIds(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, options?: any): AxiosPromise<ControllersIDsPlainResponse> {
            return DefaultApiFp(configuration).listTemplateSystemsIds(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me all my systems which have a package installed
         * @summary Show me all my systems which have a package installed
         ...
         * @throws {RequiredError}
         */
        removeTemplateSystems(body: ControllersTemplateSystemsUpdateRequest, options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).removeTemplateSystems(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me details about a system packages by given inventory id
         * @summary Show me details about a system packages by given inventory id
         ...
         * @throws {RequiredError}
         */
        updateTemplateSystems(templateId: string, body: ControllersTemplateSystemsUpdateRequest, options?: any): AxiosPromise<void> {
            return DefaultApiFp(configuration).updateTemplateSystems(templateId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * View advisory-system pairs for selected systems and installable advisories
         * @summary View advisory-system pairs for selected systems and installable advisories
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public exportTemplateSystems(templateId: string, search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any) {
        return DefaultApiFp(this.configuration).exportTemplateSystems(templateId, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listSystems(limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'last_upload' | 'rhsa_count' | 'rhba_count' | 'rhea_count' | 'other_count' | 'stale' | 'packages_installed' | 'baseline_name' | 'groups' | 'satellite_managed' | 'built_pkgcache', search?: string, filterId?: string, filterDisplayName?: string, filterLastEvaluation?: string, filterLastUpload?: string, filterRhsaCount?: string, filterRhbaCount?: string, filterRheaCount?: string, filterOtherCount?: string, filterInstallableRhsaCount?: string, filterInstallableRhbaCount?: string, filterInstallableRheaCount?: string, filterInstallableOtherCount?: string, filterApplicableRhsaCount?: string, filterApplicableRhbaCount?: string, filterApplicableRheaCount?: string, filterApplicableOtherCount?: string, filterStale?: string, filterPackagesInstalled?: string, filterPackagesInstallable?: string, filterPackagesApplicable?: string, filterStaleTimestamp?: string, filterStaleWarningTimestamp?: string, filterCulledTimestamp?: string, filterCreated?: string, filterBaselineName?: string, filterTemplateName?: string, filterTemplateUuid?: string, filterSatelliteManaged?: string, filterBuiltPkgcache?: string, filterArch?: string, filterOs?: string, filterOsname?: string, filterOsmajor?: string, filterOsminor?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any) {
        return DefaultApiFp(this.configuration).listSystems(limit, offset, sort, search, filterId, filterDisplayName, filterLastEvaluation, filterLastUpload, filterRhsaCount, filterRhbaCount, filterRheaCount, filterOtherCount, filterInstallableRhsaCount, filterInstallableRhbaCount, filterInstallableRheaCount, filterInstallableOtherCount, filterApplicableRhsaCount, filterApplicableRhbaCount, filterApplicableRheaCount, filterApplicableOtherCount, filterStale, filterPackagesInstalled, filterPackagesInstallable, filterPackagesApplicable, filterStaleTimestamp, filterStaleWarningTimestamp, filterCulledTimestamp, filterCreated, filterBaselineName, filterTemplateName, filterTemplateUuid, filterSatelliteManaged, filterBuiltPkgcache, filterArch, filterOs, filterOsname, filterOsmajor, filterOsminor, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listSystemsIds(limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'last_upload' | 'rhsa_count' | 'rhba_count' | 'rhea_count' | 'other_count' | 'stale' | 'packages_installed' | 'baseline_name' | 'satellite_managed' | 'built_pkgcache', search?: string, filterId?: string, filterDisplayName?: string, filterLastEvaluation?: string, filterLastUpload?: string, filterRhsaCount?: string, filterRhbaCount?: string, filterRheaCount?: string, filterOtherCount?: string, filterInstallableRhsaCount?: string, filterInstallableRhbaCount?: string, filterInstallableRheaCount?: string, filterInstallableOtherCount?: string, filterApplicableRhsaCount?: string, filterApplicableRhbaCount?: string, filterApplicableRheaCount?: string, filterApplicableOtherCount?: string, filterStale?: string, filterPackagesInstalled?: string, filterPackagesInstallable?: string, filterPackagesApplicable?: string, filterStaleTimestamp?: string, filterStaleWarningTimestamp?: string, filterCulledTimestamp?: string, filterCreated?: string, filterBaselineName?: string, filterTemplateName?: string, filterTemplateUuid?: string, filterOs?: string, filterOsname?: string, filterOsmajor?: string, filterOsminor?: string, filterSatelliteManaged?: string, filterBuiltPkgcache?: string, filterArch?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any) {
        return DefaultApiFp(this.configuration).listSystemsIds(limit, offset, sort, search, filterId, filterDisplayName, filterLastEvaluation, filterLastUpload, filterRhsaCount, filterRhbaCount, filterRheaCount, filterOtherCount, filterInstallableRhsaCount, filterInstallableRhbaCount, filterInstallableRheaCount, filterInstallableOtherCount, filterApplicableRhsaCount, filterApplicableRhbaCount, filterApplicableRheaCount, filterApplicableOtherCount, filterStale, filterPackagesInstalled, filterPackagesInstallable, filterPackagesApplicable, filterStaleTimestamp, filterStaleWarningTimestamp, filterCulledTimestamp, filterCreated, filterBaselineName, filterTemplateName, filterTemplateUuid, filterOs, filterOsname, filterOsmajor, filterOsminor, filterSatelliteManaged, filterBuiltPkgcache, filterArch, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public listTemplate(limit?: number, offset?: number, sort?: 'id' | 'name' | 'systems' | 'published' | 'last_edited', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any) {
        return DefaultApiFp(this.configuration).listTemplate(limit, offset, sort, search, filterId, filterName, filterSystems, tags, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public listTemplateSystems(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload' | 'groups', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, filterGroupName?: Array<string>, filterSystemProfileSapSystem?: string, filterSystemProfileSapSids?: Array<string>, filterSystemProfileAnsible?: string, filterSystemProfileAnsibleControllerVersion?: string, filterSystemProfileMssql?: string, filterSystemProfileMssqlVersion?: string, options?: any) {
        return DefaultApiFp(this.configuration).listTemplateSystems(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, filterGroupName, filterSystemProfileSapSystem, filterSystemProfileSapSids, filterSystemProfileAnsible, filterSystemProfileAnsibleControllerVersion, filterSystemProfileMssql, filterSystemProfileMssqlVersion, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public listTemplateSystemsIds(templateId: string, limit?: number, offset?: number, sort?: 'id' | 'display_name' | 'os' | 'installable_rhsa_count' | 'installable_rhba_count' | 'installable_rhea_count' | 'installable_other_count' | 'applicable_rhsa_count' | 'applicable_rhba_count' | 'applicable_rhea_count' | 'applicable_other_count' | 'last_upload', search?: string, filterDisplayName?: string, filterOs?: string, tags?: Array<string>, options?: any) {
        return DefaultApiFp(this.configuration).listTemplateSystemsIds(templateId, limit, offset, sort, search, filterDisplayName, filterOs, tags, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public removeTemplateSystems(body: ControllersTemplateSystemsUpdateRequest, options?: any) {
        return DefaultApiFp(this.configuration).removeTemplateSystems(body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public updateTemplateSystems(templateId: string, body: ControllersTemplateSystemsUpdateRequest, options?: any) {
        return DefaultApiFp(this.configuration).updateTemplateSystems(templateId, body, options).then((request) => request(this.axios, this.basePath));
    }
