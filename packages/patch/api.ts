 ...
 *
 * The version of the OpenAPI document: v1.18.93
 *
 *
 ...
 */
export interface ControllersAdvisoryDetailAttributesV1 {
    /**
     *
     * @type {string}
 ...
 */
export interface ControllersAdvisoryDetailItemV1 {
    /**
     *
     * @type {ControllersAdvisoryDetailAttributesV1}
     * @memberof ControllersAdvisoryDetailItemV1
     */
    attributes?: ControllersAdvisoryDetailAttributesV1;
    /**
     *
     * @type {string}
     * @memberof ControllersAdvisoryDetailItemV1
 ...
 */
export interface ControllersAdvisoryDetailResponseV1 {
    /**
     *
     * @type {ControllersAdvisoryDetailItemV1}
     * @memberof ControllersAdvisoryDetailResponseV1
     */
    data?: ControllersAdvisoryDetailItemV1;
}
/**
 *
 * @export
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        baselineDelete: async (baselineId: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/patch/v1/baselines/{baseline_id}`
        ...
        createBaseline: async (body: ControllersCreateBaselineRequest, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/patch/v1/baselines`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @param {number} [limit] Limit for paging, set -1 to return all
         * @param {number} [offset] Offset for paging
         * @param {'id' | 'name' | 'config'} [sort] Sort field
         * @param {string} [search] Find matching text
         * @param {string} [filterId] Filter
         * @param {string} [filterName] Filter
         ...
         * @throws {RequiredError}
         */
        listBaseline: async (limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/patch/v1/baselines`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        listBaselineSystems: async (baselineId: number, limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterDisplayName?: string, tags?: Array<string>, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'baselineId' is not null or undefined
            if (baselineId === null || baselineId === undefined) {
                throw new RequiredError('baselineId','Required parameter baselineId was null or undefined when calling listBaselineSystems.');
            }
            const localVarPath = `/api/patch/v1/baselines/{baseline_id}/systems`
                .replace(`{${"baseline_id"}}`, encodeURIComponent(String(baselineId)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
        ...
        removeBaselineSystems: async (body: ControllersBaselineSystemsRemoveRequest, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/patch/v1/baselines/systems/remove`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const DefaultApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async detailAdvisory(advisoryId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersAdvisoryDetailResponseV1>> {
         ...
         * @throws {RequiredError}
         */
        async listBaseline(limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersBaselinesResponse>> {
         ...
         * @throws {RequiredError}
         */
        async listBaselineSystems(baselineId: number, limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterDisplayName?: string, tags?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ControllersBaselineSystemsResponse>> {
            const localVarAxiosArgs = await DefaultApiAxiosParamCreator(configuration).listBaselineSystems(baselineId, limit, offset, sort, search, filterDisplayName, tags, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        detailAdvisory(advisoryId: string, options?: any): AxiosPromise<ControllersAdvisoryDetailResponseV1> {
         ...
         * @throws {RequiredError}
         */
        listBaseline(limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any): AxiosPromise<ControllersBaselinesResponse> {
         ...
         * @throws {RequiredError}
         */
        listBaselineSystems(baselineId: number, limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterDisplayName?: string, tags?: Array<string>, options?: any): AxiosPromise<ControllersBaselineSystemsResponse> {
            return DefaultApiFp(configuration).listBaselineSystems(baselineId, limit, offset, sort, search, filterDisplayName, tags, options).then((request) => request(axios, basePath));
        },
        /**
         * Show me all installed packages across my systems
         * @summary Show me all installed packages across my systems
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public listBaseline(limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterId?: string, filterName?: string, filterSystems?: string, tags?: Array<string>, options?: any) {
     ...
     * @memberof DefaultApi
     */
    public listBaselineSystems(baselineId: number, limit?: number, offset?: number, sort?: 'id' | 'name' | 'config', search?: string, filterDisplayName?: string, tags?: Array<string>, options?: any) {
        return DefaultApiFp(this.configuration).listBaselineSystems(baselineId, limit, offset, sort, search, filterDisplayName, tags, options).then((request) => request(this.axios, this.basePath));
    }
