...
*Defined in [packages/patch/base.ts:20](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L20)*
...
*Defined in [packages/patch/api.ts:932](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/api.ts#L932)*
...
* **listPackages**(`limit?`: number, `offset?`: number, `sort?`: "id" | "name" | "systems_installed" | "systems_updatable", `search?`: string, `filterName?`: string, `filterSystemsInstalled?`: string, `filterSystemsUpdatable?`: string, `tags?`: Array‹string›, `options`: any): *[RequestArgs](interfaces/requestargs.md)*
...
* **packageSystems**(`packageName`: string, `tags?`: Array‹string›, `options`: any): *[RequestArgs](interfaces/requestargs.md)*

* **systemPackages**(`inventoryId`: string, `search?`: string, `filterName?`: string, `filterDescription?`: string, `filterEvra?`: string, `filterSummary?`: string, `filterUpdatable?`: boolean, `tags?`: Array‹string›, `options`: any): *[RequestArgs](interfaces/requestargs.md)*
...
*Defined in [packages/patch/api.ts:2167](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/api.ts#L2167)*
...
*Defined in [packages/patch/api.ts:1898](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/api.ts#L1898)*
...
* **listPackages**(`limit?`: number, `offset?`: number, `sort?`: "id" | "name" | "systems_installed" | "systems_updatable", `search?`: string, `filterName?`: string, `filterSystemsInstalled?`: string, `filterSystemsUpdatable?`: string, `tags?`: Array‹string›, `options?`: any): *function*

  * (`axios?`: AxiosInstance, `basePath?`: string): *AxiosPromise‹[ControllersPackagesResponse](interfaces/controllerspackagesresponse.md)›*

* **listSystemAdvisories**(`inventoryId`: string, `limit?`: number, `offset?`: number, `sort?`: "id" | "name" | "type" | "synopsis" | "public_date", `search?`: string, `filterId?`: string, `filterDescription?`: string, `filterPublicDate?`: string, `filterSynopsis?`: string, `filterAdvisoryType?`: string, `filterSeverity?`: string, `tags?`: Array‹string›, `options?`: any): *function*
...
* **packageSystems**(`packageName`: string, `tags?`: Array‹string›, `options?`: any): *function*
...
* **systemPackages**(`inventoryId`: string, `search?`: string, `filterName?`: string, `filterDescription?`: string, `filterEvra?`: string, `filterSummary?`: string, `filterUpdatable?`: boolean, `tags?`: Array‹string›, `options?`: any): *function*
...
*Defined in [packages/patch/base.ts:26](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L26)*
...
*Defined in [packages/patch/base.ts:27](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L27)*

###  pipes

• **pipes**: *string* = "|"

*Defined in [packages/patch/base.ts:30](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L30)*

###  ssv

• **ssv**: *string* = " "

*Defined in [packages/patch/base.ts:28](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L28)*

###  tsv

• **tsv**: *string* = "	"

*Defined in [packages/patch/base.ts:29](https://github.com/RedHatInsights/javascript-clients/blob/7ed15e5/packages/patch/base.ts#L29)*
