...
*Defined in [packages/patch/base.ts:49](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/base.ts#L49)*
...
*Defined in [packages/patch/base.ts:51](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/base.ts#L51)*
...
*Defined in [packages/patch/api.ts:2771](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2771)*
...
*Defined in [packages/patch/api.ts:2783](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2783)*
...
*Defined in [packages/patch/api.ts:2795](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2795)*
...
*Defined in [packages/patch/api.ts:2814](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2814)*
...
*Defined in [packages/patch/api.ts:2834](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2834)*
...
*Defined in [packages/patch/api.ts:2857](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2857)*
...
*Defined in [packages/patch/api.ts:2869](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2869)*
...
*Defined in [packages/patch/api.ts:2894](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2894)*
...
*Defined in [packages/patch/api.ts:2921](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2921)*
...
*Defined in [packages/patch/api.ts:2943](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2943)*
...
*Defined in [packages/patch/api.ts:2965](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2965)*
...
*Defined in [packages/patch/api.ts:2993](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L2993)*
...
*Defined in [packages/patch/api.ts:3010](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L3010)*
...
*Defined in [packages/patch/api.ts:3030](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L3030)*
...
*Defined in [packages/patch/api.ts:3042](https://github.com/RedHatInsights/javascript-clients/blob/1ea6be2/packages/patch/api.ts#L3042)*
