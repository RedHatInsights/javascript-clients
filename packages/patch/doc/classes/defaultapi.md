...
*Defined in [packages/patch/base.ts:49](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/base.ts#L49)*
...
*Defined in [packages/patch/base.ts:51](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/base.ts#L51)*
...
*Defined in [packages/patch/api.ts:2498](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2498)*
...
*Defined in [packages/patch/api.ts:2510](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2510)*
...
*Defined in [packages/patch/api.ts:2522](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2522)*
...
*Defined in [packages/patch/api.ts:2541](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2541)*
...
*Defined in [packages/patch/api.ts:2564](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2564)*
...
*Defined in [packages/patch/api.ts:2576](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2576)*
...
*Defined in [packages/patch/api.ts:2601](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2601)*
...
*Defined in [packages/patch/api.ts:2628](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2628)*
...
*Defined in [packages/patch/api.ts:2650](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2650)*
...
*Defined in [packages/patch/api.ts:2672](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2672)*
...
*Defined in [packages/patch/api.ts:2700](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2700)*
...
*Defined in [packages/patch/api.ts:2715](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2715)*
...
*Defined in [packages/patch/api.ts:2733](https://github.com/RedHatInsights/javascript-clients/blob/c26bffd/packages/patch/api.ts#L2733)*
