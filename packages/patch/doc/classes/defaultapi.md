...
*Defined in [packages/patch/base.ts:49](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/base.ts#L49)*
...
*Defined in [packages/patch/base.ts:51](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/base.ts#L51)*
...
*Defined in [packages/patch/api.ts:2374](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2374)*
...
*Defined in [packages/patch/api.ts:2386](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2386)*
...
*Defined in [packages/patch/api.ts:2398](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2398)*
...
*Defined in [packages/patch/api.ts:2417](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2417)*
...
*Defined in [packages/patch/api.ts:2437](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2437)*
...
*Defined in [packages/patch/api.ts:2449](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2449)*
...
*Defined in [packages/patch/api.ts:2471](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2471)*
...
*Defined in [packages/patch/api.ts:2496](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2496)*
...
▸ **listPackages**(`limit?`: number, `offset?`: number, `sort?`: "id" | "name" | "systems_installed" | "systems_updatable", `search?`: string, `filterName?`: string, `filterSystemsInstalled?`: string, `filterSystemsUpdatable?`: string, `tags?`: string, `options?`: any): *AxiosPromise‹[ControllersPackagesResponse](../interfaces/controllerspackagesresponse.md)›*

*Defined in [packages/patch/api.ts:2515](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2515)*
...
*Defined in [packages/patch/api.ts:2537](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2537)*
...
*Defined in [packages/patch/api.ts:2563](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2563)*
...
*Defined in [packages/patch/api.ts:2575](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2575)*
...
*Defined in [packages/patch/api.ts:2593](https://github.com/RedHatInsights/javascript-clients/blob/acc93dd/packages/patch/api.ts#L2593)*
