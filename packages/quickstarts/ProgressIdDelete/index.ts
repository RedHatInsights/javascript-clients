...
export type ProgressIdDeleteReturnType = AxiosPromise<void>;
...
*/
export const progressIdDeleteParamCreator = async (...config: ([ProgressIdDeleteParams] | [number, AxiosRequestConfig])): Promise<RequestArgs> => {
