...
*Defined in [packages/rbac/api.ts:4770](https://github.com/fhlavac/javascript-clients/blob/master/packages/rbac/api.ts#L4770)*
...
*Defined in [packages/rbac/api.ts:4782](https://github.com/fhlavac/javascript-clients/blob/master/packages/rbac/api.ts#L4782)*
...
*Defined in [packages/rbac/api.ts:4794](https://github.com/fhlavac/javascript-clients/blob/master/packages/rbac/api.ts#L4794)*
...
*Defined in [packages/rbac/api.ts:4812](https://github.com/fhlavac/javascript-clients/blob/master/packages/rbac/api.ts#L4812)*
...
*Defined in [packages/rbac/api.ts:4825](https://github.com/fhlavac/javascript-clients/blob/master/packages/rbac/api.ts#L4825)*
