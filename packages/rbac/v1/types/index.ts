 ...
 * 
 * @export
 * @interface CrossAccountRequestWithRole
 */
export interface CrossAccountRequestWithRoles {
    /**
     * 
     * @type {string}
     * @memberof CrossAccountRequestWithRole
     */
    'request_id'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface GroupWithPrincipal
 */
export interface GroupWithPrincipals {
    /**
     * 
     * @type {string}
     * @memberof GroupWithPrincipal
     */
    'name': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface GroupWithPrincipalsAndRole
 */
export interface GroupWithPrincipalsAndRoles {
    /**
     * 
     * @type {string}
     * @memberof GroupWithPrincipalsAndRole
     */
    'name': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface RoleWithAcce
 */
export interface RoleWithAccess {
    /**
     * 
     * @type {string}
     * @memberof RoleWithAcce
     */
    'name': string;
    /**
     * 
