...
export type ListRolesForGroupReturnType = AxiosPromise<any>;

const isListRolesForGroupObjectParams = (params: [ListRolesForGroupParams] | unknown[]): params is [ListRolesForGroupParams] => {
  return params.length === 1 && Object.prototype.hasOwnProperty.call(params[0], 'uuid') && true && true && true && true && true && true && true && true && true
}
/**
...
*/
export const listRolesForGroupParamCreator = async (...config: ([ListRolesForGroupParams] | [any, any, any, any, any, any, any, any, any, ListRolesForGroupOrderByEnum, AxiosRequestConfig])): Promise<RequestArgs> => {
